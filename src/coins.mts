...
import { AlwaysHeadsCoin, Coin, FairCoin, FlipperContainer } from "./flippers.mjs";
import type { FlipResult, FlipSequenceResult } from "./flippers.mjs";
    ...
    flip_rnd_btn.onclick = () => {
        ...
        if (r) {
            ...
            if (Object.hasOwn(r, "label"))
                result_string.innerHTML = (r as FlipResult).label;
            if (Object.hasOwn(r, "sequence")) {
                const o = r as FlipSequenceResult;
